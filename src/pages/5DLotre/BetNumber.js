  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          <Box className="!flex !flex-col !justify-center !w-10  !m-2 !text-center"
            sx={{ cursor: "pointer" }}>
            <div

              className="border-gray-500 border text-gray-400 py-2  rounded-full"
              onClick={() => {
                setOpen(true);
                setSelectNumber("0");
              }}>0</div>
            <Box className="!text-gray-500">5.2</Box>
          </Box>
          <Box className="!flex !flex-col !justify-center !w-10  !m-2 !text-center"
            sx={{ cursor: "pointer" }}>
            <div
            ...
            <Box className="!text-gray-500">4.2</Box>
          </Box>
          <Box className="!flex !flex-col !justify-center !w-10  !m-2 !text-center"
            sx={{ cursor: "pointer" }}>
            <div
            ...
            <Box className="!text-gray-500">6.2</Box>
          </Box>
          <Box className="!flex !flex-col !justify-center !w-10  !m-2 !text-center"
            sx={{ cursor: "pointer" }}>
            <div
            ...
            <Box className="!text-gray-500">5.8</Box>
          </Box>
          <Box className="!flex !flex-col !justify-center !w-10  !m-2 !text-center"
            sx={{ cursor: "pointer" }}>
            <div
            ...
            <Box className="!text-gray-500">3.2</Box>
          </Box>
          <Box className="!flex !flex-col !justify-center !w-10  !m-2 !text-center"
            sx={{ cursor: "pointer" }}>
            <div
            ...
            <Box className="!text-gray-500">4.5</Box>
          </Box>
          <Box className="!flex !flex-col !justify-center !w-10  !m-2 !text-center"
            sx={{ cursor: "pointer" }}>
            <div
