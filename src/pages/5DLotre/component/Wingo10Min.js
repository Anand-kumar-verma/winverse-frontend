...
function Wingo10Min() {
  ...
  return (
    <Box>
      ...
      <Box sx={{ px: 1, mt: 3 }}>
        <Box
          className="countdownbgtrx !bg-white !shadow-xl"
              ...
              {React.useMemo(() => {
                return (
                  <Stack direction="row" mt={1.5}>
                    <Box className="timer !text-[#00b977] !bg-gray-200"
                      sx={{ backgroundImage: `url(${timerbg1})`, backgroundSize: '100%', backgroundPosition: 'center' }}>
